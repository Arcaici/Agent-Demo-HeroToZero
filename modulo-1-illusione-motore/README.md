...
- **L'automobile e il motore:** Copilot (o ChatGPT) come prodotto finito con
...
1. [demo-architettura-agente](demo-architettura-agente/) — pagina HTML/JS statica
   ...
   LLM ↔ dati/permessi), per rendere visibile la metafora "automobile e motore".
2. [demo-temperatura](demo-temperatura/) — stessa domanda posta più volte
   all'LLM locale, risposte diverse ogni volta; slider di temperatura per
   mostrare perché bisogna "temere" la probabilità anche se è alla base del
